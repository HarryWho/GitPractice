...
class Calendar{
    ...
    public function show(){
        ...
        $output.="<caption><div class='cal-head-container'><div><a href='/?p=".Input::get('p') ."&month=" .$this->last_month ."&year=".$this->last_year."'><i class='fas fa-chevron-circle-left'></i></a></div> <div>" .$this->date_info['month'] ." " .$this->year ."</div><div> <a href='/?p=".Input::get('p') ."&month=" .$this->next_month ."&year=".$this->next_year."'><i class='fas fa-chevron-circle-right'></i></a></div></div></caption>";
        $output.="<tr>";
